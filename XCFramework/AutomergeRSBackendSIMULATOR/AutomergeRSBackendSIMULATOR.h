//
//  AutomergeRSBackend_Simulator.h
//  AutomergeRSBackend-Simulator
//
//  Created by Lukas Schmidt on 26.06.20.
//  Copyright © 2020 Automerge. All rights reserved.
//

#import <Foundation/Foundation.h>

//! Project version number for AutomergeRSBackend_Simulator.
FOUNDATION_EXPORT double AutomergeRSBackend_SimulatorVersionNumber;

//! Project version string for AutomergeRSBackend_Simulator.
FOUNDATION_EXPORT const unsigned char AutomergeRSBackend_SimulatorVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <AutomergeRSBackend_Simulator/PublicHeader.h>
